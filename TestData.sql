...
-- Insert into Character([Name],OriginalHealth,CurrentHealth,Armor,Penetration,BaseDamage,[Level],CharacterType,CoinPurse,Class) 
-- values ('Gustavo',900,900,220,180,75,10,'Enemy',50, 'Warrior');
